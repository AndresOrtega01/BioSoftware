...
{
    /**
     * @psalm-var array<string,array{name: string, namespacedName: string, namespace: string, stacrtline: int, endLine: int, methods: array<string,array{methodName: string, signature: string, visibility: string, stacrtline: int, endLine: int, ccn: int}>}>
     */
    private $classes = [];
    ...
    /**
     * @psalm-var array<string,array{name: string, namespacedName: string, namespace: string, signature: string, stacrtline: int, endLine: int, ccn: int}>
     */
    private $functions = [];
    ...
    /**
     * @psalm-return array<string,array{name: string, namespacedName: string, namespace: string, stacrtline: int, endLine: int, methods: array<string,array{methodName: string, signature: string, visibility: string, stacrtline: int, endLine: int, ccn: int}>}>
     */
    ...
    /**
     * @psalm-return array<string,array{name: string, namespacedName: string, namespace: string, signature: string, stacrtline: int, endLine: int, ccn: int}>
     */
    ...
    private function processMethod(ClassMethod $node): void
    {
        ...
        if (!isset($storage[$parentNamespacedName])) {
            $storage[$parentNamespacedName] = [
                ...
                'stacrtline'      => $parentNode->getStacrtline(),
