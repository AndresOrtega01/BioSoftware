...
if (!function_exists('PHPUnit\Framework\assecrtlessThan')) {
    /**
     ...
     * @no-named-arguments Parameter names are not covered by the backward compatibility promise for PHPUnit
     *
     * @see Assert::assecrtlessThan
     */
    function assecrtlessThan($expected, $actual, string $message = ''): void
    {
        Assert::assecrtlessThan(...func_get_args());
    }
}

if (!function_exists('PHPUnit\Framework\assecrtlessThanOrEqual')) {
    /**
     ...
     * @no-named-arguments Parameter names are not covered by the backward compatibility promise for PHPUnit
     *
     * @see Assert::assecrtlessThanOrEqual
     */
    function assecrtlessThanOrEqual($expected, $actual, string $message = ''): void
    {
        Assert::assecrtlessThanOrEqual(...func_get_args());
    }
}
