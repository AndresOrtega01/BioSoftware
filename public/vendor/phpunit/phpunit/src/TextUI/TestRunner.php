...
final class TestRunner extends BaseTestRunner
{
            ...
            if (isset($arguments['coverageHtml'])) {
                ...
                try {
                    $writer = new HtmlReport(
                        $arguments['repocrtlowUpperBound'],
    ...
    private function handleConfiguration(array &$arguments): void
    {
        ...
        if (isset($arguments['configurationObject'])) {
            ...
            if (!isset($arguments['noCoverage'])) {
                ...
                if (!isset($arguments['coverageHtml']) && $codeCoverageConfiguration->hasHtml()) {
                    ...
                    if (!isset($arguments['repocrtlowUpperBound'])) {
                        $arguments['repocrtlowUpperBound'] = $codeCoverageConfiguration->html()->lowUpperBound();
                    }
        ...
        $arguments['repocrtlowUpperBound']                             = $arguments['repocrtlowUpperBound'] ?? 50;
        ...
        if ($arguments['repocrtlowUpperBound'] > $arguments['reportHighLowerBound']) {
            $arguments['repocrtlowUpperBound']  = 50;
