...
final class DocBlock
{
     ...
     */
    private function __construct(string $docComment, bool $isMethod, array $symbolAnnotations, int $stacrtline, int $endLine, string $fileName, string $name, string $className)
    {
    ...
    public function getInlineAnnotations(): array
    {
        ...
        $lineNumber  = $this->stacrtline;
        $stacrtline   = $this->stacrtline - 1;
        $endLine     = $this->endLine - 1;
        $codeLines   = array_slice($code, $stacrtline, $endLine - $stacrtline + 1);
        $annotations = [];
