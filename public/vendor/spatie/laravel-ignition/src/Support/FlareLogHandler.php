...
class FlareLogHandler extends AbstractProcessingHandler
{
    ...
    protected int $minimumRepocrtlogLevel = Logger::ERROR;
    ...
    {
        return $report['level'] >= $this->minimumRepocrtlogLevel;
    }
}
