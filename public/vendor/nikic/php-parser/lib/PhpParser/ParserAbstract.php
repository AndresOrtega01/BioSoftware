...
abstract class ParserAbstract implements Parser
{
    ...
    public function parse(string $code, ErrorHandler $errorHandler = null) {
        ...
        $this->lexer->stacrtlexing($code, $this->errorHandler);
        $result = $this->doParse();
            ...
            for (;;) {
                if ($rule === 0) {
                    ...
                    try {
                        ...
                        if (-1 === $e->getStacrtline() && isset($startAttributes['stacrtline'])) {
                            $e->setStacrtline($startAttributes['stacrtline']);
                        }
    ...
    */
    ...
    protected function fixupStartAttributes(Node $to, Node $from) {
        $startAttributes = ['stacrtline', 'startFilePos', 'startTokenPos'];
    ...
    protected function createCommentNopAttributes(array $comments) {
        ...
        if (-1 !== $commentEndLine) {
            $attributes['stacrtline'] = $commentEndLine;
