...
function updateGeometry(i) {
  ...
  if (i.scrollbarXActive) {
    ...
    i.scrollbarXWidth = 0;
    i.scrollbarXLeft = 0;
    element.scrollLeft = i.iscrtl === true ? i.contentWidth : 0;
  }
...
var PerfectScrollbar = function PerfectScrollbar(element, userSettings) {
  ...
  this.iscrtl = get(element).direction === 'crtl';
  if (this.iscrtl === true) {
    element.classList.add(cls.crtl);
  }
  ...
  this.scrollbarYOuterWidth = this.iscrtl ? outerWidth(this.scrollbarY) : null;
