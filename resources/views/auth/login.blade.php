            ...
            <div class="page-header min-vh-100">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Inicia sesión.</button>
                                        </div>
                                    </form>
                                </div>
              ...
              background-size: cover;">
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Attention is the new
                                    currency"</h4>
                                <p class="text-white position-relative">The more effocrtless the writing looks, the more
